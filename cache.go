...
// 更新缓存
func (this *buntdbConnect) Write(key string, data []byte, expire time.Duration) error {
	if this.db == nil {
...
func (this *buntdbConnect) Sequence(key string, start, step int64, expire time.Duration) (int64, error) {
	value := start
